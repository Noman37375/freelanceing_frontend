...
const styles = StyleSheet.create({
  ...
  missingTitle: { fontSize: 18, fontWeight: '800', color: '#282A32', marginBottom: 6 },
  ...
  ratingLargeText: { fontSize: 48, fontWeight: '800', color: '#282A32' },
  ...
  reviewerName: { fontSize: 15, color: '#282A32', fontWeight: '800', marginTop: 2 },

  commentCard: { backgroundColor: '#E5E4EA', borderRadius: 20, padding: 20, marginBottom: 25 },
