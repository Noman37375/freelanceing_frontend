                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View style={styles.emptyContainer}>
                            <Text style={styles.emptyText}>No categories yet. Add a service category to show on the homepage.</Text>
...
const styles = StyleSheet.create({
    ...
    headerTitle: { flex: 1, fontSize: 18, fontWeight: '700', color: '#444751' },
    addButton: {
        width: 40,
        height: 40,
        borderRadius: 10,
    ...
    listContent: { padding: 20, paddingTop: 5, paddingBottom: 24 },
    ...
    emptyText: { fontSize: 15, color: '#64748B', fontWeight: '500', textAlign: 'center', marginBottom: 20 },
    emptyButton: {
        flexDirection: 'row',
        alignItems: 'center',
        gap: 10,
